    ...
    public partial class NcovContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=tcp:testncov2019.database.windows.net,1433;Initial Catalog=Ncov2019;Persist Security Info=False;User ID=tk45456;Password=Concaheo45456;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
